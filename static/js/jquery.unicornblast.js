(function($) {
    ...
    $.fn.unicornblast = function(options) {
		...
		return this.each(function() {
			...
			var content = '<img id="bigRainbow" style="display: none" src="/static/img/rainbow.gif" />';
			content += '<img id="flyingUnicorn0" class="flyingUnicorn" style="display: none" src="/static/img/flyingUnicorn0.gif" />';
			content += '<img id="flyingUnicorn1" class="flyingUnicorn" style="display: none" src="/static/img/flyingUnicorn1.gif" />';
			content += '<img id="flyingUnicorn2" class="flyingUnicorn" style="display: none" src="/static/img/flyingUnicorn2.gif" />';
			content += '<img id="flyingUnicorn3" class="flyingUnicorn" style="display: none" src="/static/img/flyingUnicorn3.gif" />';
			
			//Check for audio support and add elements if supported
			if ($.browser.mozilla && $.browser.version.substr(0, 5) >= "1.9.2" || $.browser.webkit) { 
				audioSupported = true;
				content+= '<audio id="chimeSound0" preload="auto"><source src="/static/sound/chime1.mp3"/><source src="/static/sound/chime1.ogg" /></audio>';
				content+= '<audio id="chimeSound1" preload="auto"><source src="/static/sound/chime2.mp3"/><source src="/static/sound/chime2.ogg" /></audio>';
				content+= '<audio id="chimeSound2" preload="auto"><source src="/static/sound/chime3.mp3"/><source src="/static/sound/chime3.ogg" /></audio>';
				content+= '<audio id="contraSound" preload="auto" loop><source src="/static/sound/contra.mp3"/><source src="/static/sound/contra.ogg" /></audio>';
			}
